...
def read_nimrod_data(input_file):
    ...
    for key, value in nimrod_output.items():
        if key != "Data":
            print(key, ":", value)
...
if __name__ == '__main__':
    ...
    Source_Path="/home/NAS/homes/brick-10015/Nimrod_2d_data/dat"
    output_file = "/home/NAS/homes/brick-10015/Nimrod_2d_data/processed/output.tiff"

    files = os.listdir(Source_Path)
    file_path = os.path.join(Source_Path, files[0])

    # Call the main function
    nimrod = read_nimrod_data(file_path)
